...
let LaunchDetailsComponent = class LaunchDetailsComponent {
    constructor(route, launchDetailsService) {
        this.route = route;
        this.launchDetailsService = launchDetailsService;
        this.launchDetails$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((params) => params.get('id')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((id) => this.launchDetailsService.fetch({ id })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((res) => res.data.launch));
    }
};
LaunchDetailsComponent.ctorParameters = () => [
...
let LaunchListComponent = class LaunchListComponent {
    constructor(pastLaunchesService) {
        ...
        this.pastLaunches$ = this.pastLaunchesService
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((res) => res.data.launchesPast));
    }
};
LaunchListComponent.ctorParameters = () => [
...
const LaunchDetailsDocument = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default.a `
  ...
  launch(id: $id) {
    ...
    `;
let LaunchDetailsGQL = class LaunchDetailsGQL extends apollo_angular__WEBPACK_IMPORTED_MODULE_3__["Query"] {
    constructor() {
        super(...arguments);
        this.document = LaunchDetailsDocument;
    }
};
...
const PastLaunchesListDocument = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default.a `
  ...
  launchesPast(limit: $limit) {
    ...
    `;
let PastLaunchesListGQL = class PastLaunchesListGQL extends apollo_angular__WEBPACK_IMPORTED_MODULE_3__["Query"] {
    constructor() {
        super(...arguments);
        this.document = PastLaunchesListDocument;
    }
};
